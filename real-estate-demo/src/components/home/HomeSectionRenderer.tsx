...
export function HomeSectionRenderer({ section }: Props) {
  ...
  switch (section.type) {
    case "hero":
      return (
        <section style={customStyle} className="relative h-[65vh] min-h-[460px] lg:min-h-[95vh] lg:h-auto flex items-center overflow-hidden py-12 lg:py-20">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center">
              ...
              >
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#D4AF37]/15 backdrop-blur-md border border-[#D4AF37]/40 text-[#F4E4A6] text-[10px] sm:text-xs font-bold uppercase tracking-[0.25em] mb-4 lg:mb-8 shadow-[0_4px_25px_rgba(212,175,55,0.25)]">
                  <span className="w-2 h-2 rounded-full bg-[#D4AF37] animate-ping" />
                  PRESTİJLİ GAYRİMENKUL PORTFÖYÜ
                </div>
                
                <EditableElement id="home-hero-title" className="text-2xl sm:text-4xl md:text-6xl lg:text-8xl font-extrabold tracking-tight mb-4 lg:mb-8 leading-[1.1] lg:leading-[1.08]" as="h1">
                ...
                >
                  <EditableElement id="home-hero-subtitle" as="p" className="text-xs sm:text-lg lg:text-2xl text-slate-300 mb-6 lg:mb-12 max-w-2xl font-light leading-relaxed border-l-2 border-[#D4AF37] pl-4 lg:pl-6 py-1 bg-gradient-to-r from-white/5 to-transparent backdrop-blur-xs rounded-r-2xl">
                    {section.subtitle}
                  </EditableElement>
                </motion.div>
                ...
                <form onSubmit={(e) => {
                  ...
                  const q = fd.get("q") || "";
                  window.location.href = `/properties?q=${encodeURIComponent(q as string)}`;
                }} className="mb-6 max-w-md w-full bg-white/15 backdrop-blur-md border border-white/30 p-1.5 rounded-2xl flex items-center gap-2 shadow-lg">
                  <input name="q" placeholder="Şehir, ilçe veya ilan ara..." className="flex-1 bg-transparent border-0 text-white text-xs sm:text-sm outline-none px-3 placeholder-white/60" />
                  <button type="submit" className="bg-gradient-to-r from-[#D4AF37] to-[#C9A227] text-[#050816] font-bold text-[10px] sm:text-xs uppercase px-4 py-2.5 rounded-xl hover:from-[#F4E4A6] hover:to-[#D4AF37] transition-all">
                    Ara
                  </button>
                </form>
                ...
                <motion.div 
                  ...
                  className="flex flex-wrap gap-3 sm:gap-5 items-center"
                >
                  <Link href={section.buttonLink || "/properties"}>
                    <button className="h-12 px-6 sm:h-16 sm:px-10 rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#D4AF37] via-[#C9A227] to-[#8B6B15] text-[#050816] font-extrabold uppercase tracking-widest text-[10px] sm:text-sm hover:from-[#F4E4A6] hover:via-[#D4AF37] hover:to-[#C9A227] transition-all flex items-center gap-2 sm:gap-3 shadow-[0_10px_30px_rgba(212,175,55,0.4)] hover:shadow-[0_15px_40px_rgba(244,228,166,0.6)] transform hover:-translate-y-1">
                      {section.buttonText} <ArrowRight className="w-4 h-4" />
                    </button>
                  </Link>
                  <Link href="/contact" className="h-12 px-6 sm:h-16 sm:px-10 rounded-xl sm:rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold uppercase tracking-widest text-[10px] sm:text-sm hover:bg-white/20 transition-all flex items-center justify-center shadow-lg hover:border-[#D4AF37]/50">
                    VIP İLETİŞİM
                  </Link>
                </motion.div>
              </motion.div>
              
              {/* Asymmetrical Floating Stats Card - Desktop Only */}
              <motion.div 
              ...
              >
                <div className="bg-slate-950/80 backdrop-blur-xl p-6 sm:p-8 rounded-[1.75rem] sm:rounded-[2.5rem] border border-[#D4AF37]/30 shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative overflow-hidden group">
                  ...
                  <div className="space-y-6 sm:space-y-8 relative z-10">
                    <div className="border-b border-[#D4AF37]/20 pb-4 sm:pb-6">
                      <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-[#D4AF37] block mb-1">DÜNYA STANDARTLARI</span>
                      <h3 className="text-lg sm:text-xl font-bold text-white tracking-tight">Rakamlarla Luxury Gold</h3>
                    </div>
    ...
    case "featured_properties":
      ...
      return (
        <section style={customStyle} className="py-16 md:py-32 bg-white dark:bg-[#050816] border-b border-slate-100 dark:border-[#D4AF37]/20 overflow-hidden">
    ...
    case "popular_regions":
      return (
        <section style={customStyle} className="py-16 md:py-32 bg-slate-50 dark:bg-[#0B1120] border-b border-slate-100 dark:border-[#D4AF37]/20 overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-10 md:mb-20 gap-6 md:gap-8">
              <div className="max-w-3xl">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#D4AF37]/10 dark:bg-[#D4AF37]/15 border border-[#D4AF37]/30 text-brand-600 dark:text-[#D4AF37] text-xs font-bold uppercase tracking-[0.25em] mb-6 shadow-[0_4px_20px_rgba(212,175,55,0.15)]">
                ...
                return (
                  ...
                  >
                    <Link href={`/properties?city=${region.title}`} className="relative block aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-xl shadow-slate-200 dark:shadow-none border dark:border-[#D4AF37]/20">
                      ...
                      <div className="absolute inset-x-0 bottom-0 p-4 sm:p-8 transform group-hover:-translate-y-2 transition-transform duration-500">
                        <div className="bg-slate-900/90 backdrop-blur-md p-5 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-[#D4AF37]/30 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
    ...
    case "about":
      return (
        <section style={customStyle} className="py-16 md:py-32 bg-white dark:bg-[#050816] overflow-hidden border-b border-slate-100 dark:border-[#D4AF37]/20">
          <div className="container mx-auto px-4">
              ...
              <div className="lg:col-span-6 space-y-8 lg:pl-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-6 border-t border-slate-100 dark:border-[#D4AF37]/20">
                  {section.items?.map((item, i) => (
                    <div key={i} className="flex items-center gap-4 sm:gap-5 p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-slate-50 dark:bg-[#111827] border border-slate-100 dark:border-[#D4AF37]/20 shadow-sm">
    ...
    case "statistics":
      return (
        <section style={customStyle} className="py-16 md:py-32 bg-gradient-to-r from-[#111827] via-[#172033] to-[#111827] dark:from-[#0B1120] dark:via-[#111827] dark:to-[#0B1120] text-white relative overflow-hidden border-b border-[#D4AF37]/20 shadow-[inset_0_0_80px_rgba(0,0,0,0.8)]">
          ...
          <div className="container mx-auto px-4 relative z-10">
            {section.title && (
              <div className="text-center mb-12 md:mb-24 max-w-4xl mx-auto">
                ...
                <EditableElement id={`section-${section.id}-title`} as="h2" className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight mb-6 leading-[1.1]">
                  {renderCinematicTitle(section.title, true)}
                </EditableElement>
            ...
            <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-${section.settings?.columns || 4} gap-10 md:gap-16`}>
              {section.items?.map((stat, i) => (
                <motion.div 
                  key={i} 
                  initial={{ opacity: 0, y: 40 }} 
    ...
    case "cta":
      return (
        <section style={customStyle} className="py-16 md:py-24 bg-white dark:bg-[#050816] overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="relative rounded-[2rem] md:rounded-[4rem] overflow-hidden p-6 sm:p-12 md:p-24 lg:p-32 text-center border border-[#D4AF37]/40 shadow-[0_20px_60px_rgba(212,175,55,0.3)]">
              ...
              <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <EditableElement id={`section-${section.id}-title`} as="h2" className="text-3xl sm:text-5xl md:text-7xl font-extrabold text-white mb-6 sm:mb-8 leading-[1.1] tracking-tight">
                  {renderCinematicTitle(section.title, true)}
                </EditableElement>
                <EditableElement id={`section-${section.id}-subtitle`} as="p" className="text-base sm:text-xl md:text-2xl text-[#F4E4A6] mb-8 sm:mb-12 font-light leading-relaxed max-w-3xl mx-auto">
                  {section.subtitle}
                </EditableElement>
    ...
    case "video_showcase":
      ...
      return (
        <section style={customStyle} className="py-16 md:py-32 bg-[#0B1120] text-white overflow-hidden border-b border-[#D4AF37]/20 shadow-[inset_0_0_80px_rgba(0,0,0,0.8)]">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                ...
                return (
                  ...
                  >
                    <Link 
                      ...
                      className="group flex flex-col items-center p-6 sm:p-12 rounded-[2rem] sm:rounded-[3rem] bg-slate-50 dark:bg-[#111827] border border-slate-100 dark:border-[#D4AF37]/25 hover:border-[#D4AF37] hover:bg-white dark:hover:bg-[#172033] transition-all duration-500 shadow-sm hover:shadow-[0_20px_40px_rgba(212,175,55,0.25)] shadow-slate-200 dark:shadow-none"
                    >
                      <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-[2rem] sm:rounded-[2.5rem] bg-[#D4AF37]/10 text-brand-600 dark:text-[#D4AF37] flex items-center justify-center mb-6 sm:mb-8 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500 shadow-[0_0_20px_rgba(212,175,55,0.15)] border border-[#D4AF37]/20">
    ...
    case "services":
      return (
        <section style={customStyle} className="py-16 md:py-32 bg-white dark:bg-[#0B1120] border-b border-slate-100 dark:border-[#D4AF37]/20 overflow-hidden">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 text-left">
              {section.items?.map((service, i) => (
                <div key={i} className="p-6 sm:p-12 rounded-[2rem] sm:rounded-[3rem] bg-slate-50 dark:bg-[#111827] border border-slate-100 dark:border-[#D4AF37]/25 hover:border-[#D4AF37] transition-all duration-500 group hover:shadow-[0_20px_50px_rgba(212,175,55,0.25)] flex flex-col justify-between">
                  <div>
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-[1.5rem] sm:rounded-[2.5rem] bg-gradient-to-r from-[#D4AF37] via-[#C9A227] to-[#8B6B15] text-[#050816] flex items-center justify-center mb-8 sm:mb-10 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500 shadow-[0_10px_30px_rgba(212,175,55,0.4)] border border-[#F4E4A6]/30">
